...
my %oid_db=(
	...
	'1.3.6.1.4.1.27952'		=> { 'desc'=>'Ğàñøèğåíèÿ ÃÏÁ (ÎÀÎ)' },
	'1.3.6.1.4.1.27952.0.1'		=> { 'desc'=>'Êîíòåéíåğ êëş÷à ÃÏÁ (ÎÀÎ)', 'asn'=>'DirectoryString'},
	...
	'1.2.643.2.2.34.2'	=> { 'desc'=>'Âğåìåííûé äîñòóï ê Öåíòğó Ğåãèñòğàöèè' },
	'1.2.643.2.2.34.6'	=> { 'desc'=>'Ïîëüçîâàòåëü Öåíòğà Ğåãèñòğàöèè, HTTP, TLS êëèåíò' },
